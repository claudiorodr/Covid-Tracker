        ...
        2: [function (t, e, n) {
            function i(t) {
                if (t) {
                    ...
                    if (s) {
                        s = s[1];
                        for (var u = 0; u < o.length; u++) o[u] = parseInt(s[u] + s[u], 16)
                    } else if (s = t.match(n)) {
                        s = s[1];
                        for (var u = 0; u < o.length; u++) o[u] = parseInt(s.slice(2 * u, 2 * u + 2), 16)
                    } else if (s = t.match(i)) {
                ...
                t.defaults.line = {
                    ...
                    update: function (t) {
                        ...
                        for (g && (r = s.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), s._scale = h, s._datasetIndex = o.index, s._children = u, s._model = {
                            ...
                            }, s.pivot()), i = 0, a = u.length; a > i; ++i) o.updateElement(u[i], i, t);
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    ...
                    configure: function (t, e, n) {
                        for (var i, a = ["fullWidth", "position", "weight"], r = a.length, o = 0; r > o; ++o) i = a[o], n.hasOwnProperty(i) && (e[i] = n[i])
                    },
                    ...
                    inRange: function (t, n) {
                        ...
                        if (i) {
                            for (var a = e.getAngleFromPoint(i, {
                                    x: t,
                                    y: n
                                }), r = a.angle, o = a.distance, l = i.startAngle, s = i.endAngle; l > s;) s += 2 * Math.PI;
                            for (; r > s;) r -= 2 * Math.PI;
                            for (; l > r;) r += 2 * Math.PI;
                            var u = r >= l && s >= r,
        ...
        41: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function o(t, e, n, i, a) {
                    var r;
                    if (i && a) {
                        for (t.moveTo(e[0].x, e[0].y), r = 1; i > r; ++r) u.canvas.lineTo(t, e[r - 1], e[r]);
                ...
                return {
                    ...
                    afterDatasetsUpdate: function (r, o) {
                        var l, s, u, d, c = (r.data.datasets || []).length,
                            h = o.propagate,
                            f = [];
                        for (s = 0; c > s; ++s) l = r.getDatasetMeta(s), u = l.dataset, d = null, u && u._model && u instanceof t.elements.Line && (d = {
